...
print " [00]> Exit"
print
bhydra = raw_input("FbiTactical Brute-Force Console ==>> ")
...
if bhydra == '01' or bhydra == '1':
  ...
  os.system("clear")
  os.system("figlet G-mail Brute-Force")
 ...
 os.system("python2 facebook")
	...
	os.system("python2 FbiTactical.py")
