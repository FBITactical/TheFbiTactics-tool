## TheFbiTactics.py - TheFbiTactics v1.0
# -*- coding: utf-8 -*-
import os
import sys
from time import sleep as timeout
from core.TFTcore import *
...
def main():
	...
	print "   [08] Other\n"
	print "   [10] Exit the TheFbiTactics\n"
	TheFbiTactics = raw_input("lzmx > ")
	...
	if lazymux == "1" or lazymux == "01":
	...
	elif TheFbiTactics == "2" or TheFbiTactics == "02":
		print "\n    [01] Nmap"
	...
	elif TheFbiTactics == "3" or TheFbiTactics == "03":
		print "\n    [01] Torshammer"
		print "    [02] Slowloris"
	...
	elif TheFbiTactics == "4" or TheFbiTactics == "04":
		print "\n    [01] Hydra"
	...
	elif TheFbiTactics == "5" or TheFbiTactics == "05":
		print "\n    [01] sqlmap"
		print "    [02] Webdav"
		print "    [03] xGans"
		...
		if webhack == "01" or webhack == "1":
			...
			timeout(2)
			restart_program()
	elif TheFbiTactics == "6" or TheFbiTactics == "06":
		print "\n    [01] Metasploit"
		print "    [02] commix"
		print "    [03] sqlmap"
		print "    [04] Brutal"
		...
		if exploitool == "01" or exploitool == "1":
			...
			timeout(2)
			restart_program()
	elif TheFbiTactics == "7" or TheFbiTactics == "07":
		print "\n    [01] KnockMail"
	...
	elif TheFbiTactics == "8" or TheFbiTactics == "08":
		print "\n    [01] SpiderBot"
		print "    [02] Ngrok"
		print "    [03] Sudo"
		print "    [04] Ubuntu"
